...
![image](https://github.com/ZhangDengwei/IIBacFinder/blob/main/IMGs/1.tif)

*Overview of IIBacFinder specializing in detecting unmodified bacteriocins*

![image](https://github.com/ZhangDengwei/IIBacFinder/blob/main/IMGs/2.tif)

*Schematic flow of bacteriocin mining in IIBacFinder*

## Installation

1. Download the latest version of IIBacFinder from [zenodo](https://zenodo.org/records/10996042). Of note, do not clone the package directly from the GitHub repository as it is incomplete
